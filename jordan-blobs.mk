...
PRODUCT_COPY_FILES += \
	...
	device/motorola/jordan/prebuilt/etc/init.d/07gpiofix:system/etc/init.d/07gpiofix \
	device/motorola/jordan/prebuilt/etc/init.d/08ledsfix:system/etc/init.d/08ledsfix \
