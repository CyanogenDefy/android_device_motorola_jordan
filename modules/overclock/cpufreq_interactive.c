...
SYMSEARCH_DECLARE_FUNCTION_STATIC(int, ss_sched_setscheduler_nocheck, struct task_struct *, int, struct sched_param *);
SYMSEARCH_DECLARE_FUNCTION_STATIC(void, ss_put_task_struct, struct task_struct *);
...
static int __init cpufreq_interactive_init(void)
{
	...
	SYMSEARCH_BIND_FUNCTION_TO(cpufreq_interactive, sched_setscheduler_nocheck, ss_sched_setscheduler_nocheck);
	SYMSEARCH_BIND_FUNCTION_TO(cpufreq_interactive, __put_task_struct, ss_put_task_struct);
	...
	ss_sched_setscheduler_nocheck(up_task, SCHED_FIFO, &param);
...
err_freeuptask:
	if (atomic_dec_and_test(&up_task->usage))
		ss_put_task_struct(up_task);
	return -ENOMEM;
}
